const homeIcon = ({ size }) => {
  return (
    <svg
      ...
      height={size}
      width={size}
      className="Svg-ytk21e-0 eqtHWV home-active-icon"
      aria-hidden="true"
      viewBox="0 0 24 24"
    >
      <path
...
const searchIcon = ({ size }) => {
  return (
    <svg
      ...
      height={size}
      width={size}
      className="Svg-ytk21e-0 eqtHWV search-icon"
      aria-hidden="true"
      viewBox="0 0 24 24"
    >
      <path
...
const collectionIcon = ({ size }) => {
  return (
    <svg
      ...
      height={size}
      width={size}
      className="Svg-ytk21e-0 eqtHWV collection-icon"
      aria-hidden="true"
      viewBox="0 0 24 24"
    >
      <path
...
const prevIcon = ({ size }) => {
  return (
    <svg
      ...
      height={size}
      width={size}
      className="Svg-ytk21e-0 dUrrjJ IYDlXmBmmUKHveMzIPCF"
      viewBox="0 0 24 24"
    >
      <path
...
const downDirIcon = ({ size }) => {
  return (
    <svg
      ...
      height={size}
      width={size}
      class="Svg-ytk21e-0 eqtHWV eAXFT6yvz37fvS1lmt6k"
      aria-hidden="true"
      viewBox="0 0 16 16"
    >
...
const playerFullScreenIcon = ({ size }) => {
  return (
    <svg
      role="img"
      height={size}
...
const playerPictureInPictureIcon = ({ size }) => {
  return (
...
const playerVolumeFullIcon = ({ size }) => {
  return (
    <svg
      role="presentation"
      height={size}
...
const playerVolumeNormalIcon = ({ size }) => {
  return (
    <svg
      role="presentation"
      height={size}
...
const playerVolumeLowIcon = ({ size }) => {
  return (
    <svg
      role="presentation"
      height={size}
...
const Icon = ({ name, size = 24 }) => {
  const icons = {
    ...
    playerShuffel: playerShuffelIcon,
    playerLoop: playerLoopIcon,
    playerLyrics: playerLyricsIcon,
    playerQuenue: playerQueueIcon,
    playerDevice: playerDeviceIcon,
    playerFullScreen: playerFullScreenIcon,
    playerPictureInPicture: playerPictureInPictureIcon,
    playerHeart: playerHeartIcon,
    playerMuted: playerMutedIcon,
    playerVolumeFull: playerVolumeFullIcon,
    playerVolumeNormal: playerVolumeNormalIcon,
    playerVolumeLow: playerVolumeLowIcon,
